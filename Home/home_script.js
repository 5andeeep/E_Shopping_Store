const product = {
  ...
  allBtn.addEventListener('click',()=>{
    ...
    menBtn.classList.remove("button-active");
    womenBtn.classList.remove("button-active");  
    jewelleryBtn.classList.remove("button-active");  
    electronicsBtn.classList.remove("button-active");  
  ...
  menBtn.addEventListener('click',()=>{
    ...
    menBtn.classList.add("button-active");
    womenBtn.classList.remove("button-active");  
    jewelleryBtn.classList.remove("button-active");  
    electronicsBtn.classList.remove("button-active");
  ...
  womenBtn.addEventListener('click',()=>{
    ...
    allBtn.classList.remove("button-active");
    menBtn.classList.remove("button-active");
    womenBtn.classList.add("button-active");  
    jewelleryBtn.classList.remove("button-active");  
    electronicsBtn.classList.remove("button-active");
  ...
  jewelleryBtn.addEventListener('click',()=>{
    ...
    menBtn.classList.remove("button-active");
    womenBtn.classList.remove("button-active");  
    jewelleryBtn.classList.add("button-active");  
    electronicsBtn.classList.remove("button-active");
  ...
  electronicsBtn.addEventListener('click',()=>{
    ...
    womenBtn.classList.remove("button-active");  
    jewelleryBtn.classList.remove("button-active");  
    electronicsBtn.classList.add("button-active");
...
// logout function and profile section working from here
const userNameTab = document.getElementById("user-name");
if (localStorage.getItem("currUser")) {
  let user = JSON.parse(localStorage.getItem("currUser"));
  userNameTab.innerText = "Hi, " + user.firstName;
} else {
  userNameTab.innerText = "User";
}
// logout
